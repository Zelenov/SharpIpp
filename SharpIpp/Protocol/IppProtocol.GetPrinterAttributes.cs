    ...
    internal partial class IppProtocol
    {
        ...
        public void Write(GetPrinterAttributesRequest request, Stream stream)
        {
            ...
            var attributes = new[]
            {
                ...
                new IppAttribute(Tag.Uri, "printer-uri", request.PrinterUri.ToString())
            }.Where(s => s != null);

            writer.WriteBigEndian((short) request.IppVersion);
            writer.WriteBigEndian((short) IppOperationType.GetPrinterAttributes);
        ...
        static void ConfigureGetPrinterAttributesResponse(IMapperConfigurationExpression cfg)
        {
            ...
            cfg.CreateMap<IDictionary<string, IppAttribute[]>, GetPrinterAttributesResponse>()
               ...
               .ForMember(dst => dst.UriAuthenticationSupported, opt => opt.MapFromDicSet("uri-authentication-supported"))
               ...
               .ForMember(dst => dst.PrinterMoreInfoManufacturer, opt => opt.MapFromDic("printer-more-info-manufacturer"))
               ...
               .ForMember(dst => dst.MultipleDocumentJobsSupported, opt => opt.MapFromDic("multiple-document-jobs-supported"))
               ...
               .ForMember(dst => dst.GeneratedNaturalLanguageSupported, opt => opt.MapFromDicSet("generated-natural-language-supported/"))
               ...
               .ForMember(dst => dst.ReferenceUriSchemesSupported, opt => opt.MapFromDicSetNull("reference-uri-schemes-supported"))
