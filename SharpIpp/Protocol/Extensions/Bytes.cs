...
namespace SharpIpp.Protocol.Extensions
{
    internal static class Bytes
    {
        ...
        public static ushort Reverse(ushort value) => (ushort) (((value & 0xFF00) >> 8) | ((value & 0x00FF) << 8));
        ...
        public static uint Reverse(uint value) =>
            ((value & 0xff000000) >> 24) | ((value & 0x00ff0000) >> 8) | ((value & 0x0000ff00) << 8) |
            ((value & 0x000000ff) << 24);
        ...
        public static ulong Reverse(ulong value) =>
            ((value & 0xFF00000000000000) >> 56) | ((value & 0x00FF000000000000) >> 40) |
