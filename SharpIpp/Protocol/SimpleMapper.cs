...
namespace SharpIpp.Protocol
{
    internal class SimpleMapper
    {
        ...
        public void CreateMap<TSource, TDest>(Func<TSource, TDest, SimpleMapper, TDest> mapFunc)
        {
            CreateMap(typeof(TSource), typeof(TDest),
        ...
        public void CreateMap(Type sourceType, Type destType, Func<object, object, SimpleMapper, object> mapFunc)
        {
        ...
        public TDest Map<TDest>(object source) => Map<TDest>(source, default);

        public TDest Map<TDest>(object source, TDest dest) => Map(source, source.GetType(), dest);

        public TDest Map<TSource, TDest>(TSource source) => Map<TSource, TDest>(source, default);

        public TDest Map<TSource, TDest>(TSource source, TDest dest) => Map(source, typeof(TSource), dest);
