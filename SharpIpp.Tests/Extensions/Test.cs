...
namespace SharpIpp.Tests.Extensions
{
    public static class Test
    {
        ...
        {
            var json = JsonSerializer.Serialize(obj, typeof(T), new JsonSerializerOptions {WriteIndented = true});
        ...
        {
            var folder = Path.Combine(TestContext.CurrentContext.WorkDirectory, "output",
